...
//							   ...)
// Returns: 
// 		topologically sorted array of node ids, or error message if graph is 
//		unsortable (i.e. contains cycles)

class TOPOLOGICAL_SORT {

public function tsort($nodeids, $edges) {
	...
	foreach($nodes as $n) {
		if (!empty($n['in']) or !empty($n['out'])) {
			//////echo "TOPO FAIL: cyclic<br>";
			echo "Cyclic dependency - not sortable as graph is cyclic<br>";
			return false;
		}
	}
